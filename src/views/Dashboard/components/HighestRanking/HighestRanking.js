...
import { Card, CardHeader, CardContent, Divider, Table, TableBody, TableCell, TableRow, CircularProgress, CardActions, Button } from "@material-ui/core";
  ...
  return (
    <Card {...rest} className={clsx(classes.root, className)}>
      <CardHeader
        ...
        title="Highest Ranking - Last 30 Days"
      />
      <Divider />
